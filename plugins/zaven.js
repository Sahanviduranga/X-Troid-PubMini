...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'zaven ?(.*)', fromMe: true, dontAddCommandList: true, }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/logoaveng?apikey=${Config.LOGO_KEY}&text1=xxx&text2=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
