...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'zttok ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/gtext?apikey=${Config.LOGO_KEY}&text1=${encodeURIComponent(match[1])}&text2=X-Troid`, { responseType: 'arraybuffer' })
