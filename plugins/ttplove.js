...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'zlove ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'zlove ?(.*)', fromMe: false,deleteCommand: false,dontAddCommandList: true}, (async (message, match) => {
