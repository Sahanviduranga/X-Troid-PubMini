...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'tglow ?(.*)', fromMe: true, desc: Lang.GLOW_DESC }, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'tglow ?(.*)', fromMe: false, desc: Lang.GLOW_DESC }, (async (message, match) => {
