...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'zwolf ?(.*)', fromMe: true,dontAddCommandList: true }, (async (message, match) => {
        ...
        var ttinullimage = await axios.get(`https://api.zeks.xyz/api/wolflogo?apikey=${Config.LOGO_KEY}&text1=X-Troid&text2=${encodeURIComponent(match[1])}`, { responseType: 'arraybuffer' })
