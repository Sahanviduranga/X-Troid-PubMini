...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'zcf ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'zcf ?(.*)', fromMe: false,deleteCommand: false,dontAddCommandList: true }, (async (message, match) => {
