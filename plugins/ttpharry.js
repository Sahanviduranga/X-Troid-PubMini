...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'zharry ?(.*)', fromMe: true, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'zharry ?(.*)', fromMe: false,deleteCommand: false,dontAddCommandList: true }, (async (message, match) => {
