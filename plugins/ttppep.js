...
if (Config.WORKTYPE == 'private') {
    ...
    Asena.addCommand({ pattern: 'pep ?(.*)', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({ pattern: 'pep ?(.*)', fromMe: false,deleteCommand: false,dontAddCommandList: true}, (async (message, match) => {
